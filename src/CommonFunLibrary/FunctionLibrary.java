...
public class FunctionLibrary {
	...
	public static WebDriver startbrowser()throws Throwable
	{
		...
		else if(PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("firefox"))
		{
			...
			System.setProperty("webdriver.gecko.driver", "D:\\OJTFrameWorks\\ERP_StockAccounting\\CommonDrivers\\geckodriver.exe");
...
FileWriter fw= new FileWriter("D:\\OJTFrameWorks\\ERP_StockAccounting\\CaptureData\\snumber.txt");
...
{
FileReader fr= new FileReader("D:\\OJTFrameWorks\\ERP_StockAccounting\\CaptureData\\snumber.txt");
